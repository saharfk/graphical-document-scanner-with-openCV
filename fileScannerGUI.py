...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_6.setText(_translate("Dialog", "Warp Gray scan"))
        self.pushButton_7.setText(_translate("Dialog", "black and white scan"))
        self.pushButton_8.setText(_translate("Dialog", "binary scan"))
        ...
        self.pushButton_10.setText(_translate("Dialog", "gray scan"))
